...
# Introduction
This is the simulation study for the mixture of bivariate skew Gaussian kernels. In this example, we repeatedly sample from this mixture, then cluster the data using FOLD, VI, Binder's, and \texttt{mclust}. This implementation is done using the \texttt{foreach} package in order to speed up computation. If you just want to see the results of one replication from this method, see the file "mvsn_cluster.R" in the "rfuncts" folder.

# Preliminaries
```{r}
# r functions
source("rfuncts/multivar_skewed.R")
source("rfuncts/mvnorm_gibbs.R")
source("rfuncts/mnorm_D_apply.R")
source("rfuncts/mergeloss.R")
source("rfuncts/mvsn_cluster.R")
source("rfuncts/multivar_skewed.R")
