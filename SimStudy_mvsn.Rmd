...
# Introduction
This is the simulation study for the mixture of bivariate skew Gaussian kernels. In this example, we repeatedly sample from this mixture, then cluster the data using FOLD, VI, Binder's, and \texttt{mclust}. This implementation is done using the \texttt{foreach} package in order to speed up computation. If you just want to see the results of one replication from this method, see the file "mvsn_cluster.R" in the "extra_R" folder.

# Preliminaries
```{r}
# r functions
source("extra_R/multivar_skewed.R")
source("extra_R/mvsn_cluster.R")
# parallel computing
n.cores <- 10
## create the cluster
